...
/**
 * This is the model class for table "sys_items_sql".
 *
 * The followings are the available columns in table 'sys_items_sql':
 * @property integer $id
 ...
 */
class SysItemsSql extends CActiveRecord
{
	/**
	 ...
	 * @return SysItemsSql the static model class
	 */
