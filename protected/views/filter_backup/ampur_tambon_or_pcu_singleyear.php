                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="padding: 5px; position: relative;">
                        ...
                        <div class="row" id="filter_type" style=" display: none;">
                            <div class="col-md-12 col-sm-12">
                                <input type="radio" name="type" value="tambon" onclick="set_type(this.value);"/> ดูรายตำบล<br/>
                                <input type="radio" name="type" value="pcu" onclick="set_type(this.value);"/> ดูรายสถานบริการ
                            </div>
                        </div>
