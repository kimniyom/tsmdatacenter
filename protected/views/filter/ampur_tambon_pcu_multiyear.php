...
<html>
    ...
    <body>
                    ...
                    <div class="modal-body" style="padding: 5px; position: relative;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <label>
                                    <?php
                                    echo "<font id=tumbon><select class='' id=tumbon>\n";
                                    echo "<option value='0'>--------------------</option> \n";
                                    echo "</select></font>\n";
                                    ?>
                                </label>
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <label>
                                    <?php
                                    echo "<font id=pcu><select class='' id=pcu>\n";
                                    echo "<option value='0'>--------------------</option> \n";
                                    echo "</select></font>\n";
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12" style=" text-align: center;">
                                <div class="btn btn-info" onclick="send_param();" style=" width: 100%;">
                                    <i class="fa fa-search" id="btn_report"></i> <?php echo Language::TextFilterSubmitl() ?>
                                </div>
                            </div>
                        </div>
        ...
        <div class="panel panel-warning" style=" border: none; background: none; margin-bottom: 0px;">
