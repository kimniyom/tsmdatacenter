    ...
    <head>
        ...
        <script type="text/javascript">
            function send_param() {
                ...
                var data = {distId: ampur, year: year, pcu: pcu, code506: code506};
                //alert(data);
        ...
        <script language=Javascript>
            ...
            function dochange(src, val) {
                var req = Inint_AJAX();
                var filter = "Ampur_selectpcur506_singleyear";
                    ...
                    <div class="modal-body" style="padding: 5px; position: relative;">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <label>
                                    <?php
                                    echo "<font id=pcu><select class='form-control input-sm' id=pcu>\n";
                                    echo "<option value='0'>--------------------</option> \n";
                                    echo "</select></font>\n";
                                    ?>
                                </label>
