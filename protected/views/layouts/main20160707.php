...
<html>
    <head>
        ...
        <!-- Report Css -->
        <link rel="stylesheet" href="<?php echo Yii::app()->baseUrl; ?>/css/report/report-metro.css"/>
    ...
    <body>
                ...
                <div class="container">
                    <div id="sidebar-wrapper" class="sidebar-toggle">
                        ...
                        <ul class="sidebar-nav">
                            <li class="">
                                <div style=" position: absolute; top: 8%; width: 100%; text-align: center; font-size: 30px; background: url('<?php echo Yii::app()->baseUrl ?>/images/shadow_w.png');">
                                    <?php echo Yii::app()->session['ampurname']; ?>
                                </div>
                            ...
                            <li style="text-align:center; background: #666666; color: #FFF; font-weight: bold; border-bottom: solid 1px #A0A0A0;">
                                <span class="glyphicon glyphicon-arrow-down"></span> กลุ่มข้อมูล 
                            </li>
                            <?php if (Yii::app()->session['name'] == '') { ?>
                                ...
                                foreach ($catalog as $rs):
                                    ...
                                    $count = new SysReportgroup();
                                    $TOTAL = $count->getcountgroup($rs['id']);
                                    ?>
                                    <li>
                                        <a href="<?php echo Yii::app()->createUrl('main/GetSubmenu', array("catalog_id" => $rs['id'], "menu_id" => $menu_id, "catalogname" => $rs['name'])); ?>" <?php echo $active; ?>>
                                            ...
                                            <img src="<?php echo Yii::app()->baseUrl; ?>/images/Groups-icon.png" height="26" style=" margin-left: 3px;"/>
                                            <?php echo $rs['name']; ?> 
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="navbar-header">
                            ...
                            <div class="navbar-brand" id="back_btn" style="padding-top:0px; height: 30px;display: none; list-style-type: none;">
                                <a href="Javascript:(0);" onclick="history.back();"
                                   data-toggle="tooltip" data-placement="bottom" title="กลับ">
                                    <i class="fa fa-angle-left fa-3x" id="listnone"></i>
                                </a>
                            </div>
                            ...
                            <a class="navbar-brand" style="padding:2px; padding-right:1px; padding-left: 0px;">
                                <img src="<?php echo Yii::app()->baseUrl; ?>/images/logo1-sm.png" id="tak_logo" style="margin-top: 10px; height:40px; margin-left:5px;"/>
                            </a>
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                <li style=" padding-top: 0px;">
                                    <a style=" font-size: 24px; color: #ffff00;">ศูนย์ข้อมูลสาธารณสุข <?php echo Yii::app()->session['ampurname']; ?></a>
                                </li>
                                <li>
                                    <a>
                                        <i class="fa fa-calendar-o"></i>
                                        <span id='servertime'  style="text-align: center; font-weight: bold;"></span>
                                        <i class="fa fa-clock-o"></i>
                                        <span id='ct'  style="text-align: center;"></span>
                                    </a>
                                </li>
                            </ul>
        ...
        <!-- /#wrapper -->
        <div style=" position: fixed; bottom: 0px; width: 100%; height:20px; text-align: right; font-size: 12px; color: #000; padding-right:20px; ">
            &COPY;  ระบบศูนย์ข้อมูลจังหวัดตาก จัดทำโดย งานเทคโนโลยีสารสนเทศสำนักงานสาธารณสุขจังหวัดตาก
        </div>
    </body>
</html>
